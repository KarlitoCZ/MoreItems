...
namespace MoreItems
{
    internal class CustomEnemyAI : EnemyAI
    {
        ...
        {
            base.Start();
            LogIfDebugBuild("Teacher Spawned");
        ...
        public override void Update()
        {
            ...
            {
                if (turnCompass == null) { LogIfDebugBuild("turnCompass is null"); return; }
        ...
        public void SwingAttackHitClientRpc()
        {
            ...
            if (attackArea == null) { LogIfDebugBuild("attackArea is null"); return; }
